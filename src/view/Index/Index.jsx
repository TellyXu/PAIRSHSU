            ...
            <main className="text-white">
                ...
                <div className="relative pb-20 bg-rose-300 bg-opacity-15 overflow-hidden"
                    ...
                    <div className="w-11/12 relative z-20 text-center mx-auto">
                        ...
                        <div className='relative mt-8 lg:flex'>
                            <div
                                className='w-full text-left lg:pr-20 box-border'>
                                ...
                                <div className='mt-8 pt-4 right-content-line4'>
                ...
                <div className='lg:px-20 lg:py-10 p-4 relative overflow-hidden' style={{ background: "white" }}>
                    <div className='text-center'>
                        ...
                        <p className='mt-4 text-xl text-black'>{data.main.regionFour.titleSecondary1}</p>
                        <p className='mt-4 text-xl text-black'>{data.main.regionFour.titleSecondary2}</p>
                        <div
                            onClick={() => {
